            ...
            i=MenuChoixCompte();
                switch(i)
                    {   case 0: return;
                        ...
                        case 4: {C.CreationCB();
                                break;}
                        default:cout<<"Entrez un chiffre en 0 et 4"<<endl;
                                break;
                    }
	}while(i<0 && i>4);
}
        ...
        switch(i)
            {
                ...
                default:cout<<"Entrez un chiffre entre 0 et 4"<<endl;
                            break;
                }
	}while(i<0 && i>4);
}
                ...
                switch(i)
                    {
                        ...
                        case 1: {GestionMenu::OperationPEL(C.comptePEL);
                                break;}

                        case 2: {GestionMenu::OperationEcompte(C.compteEC);
                                break;}

                        case 3: {GestionMenu::OperationLivretEpargne(C.compteLE);
                                break;}

                        case 4: {GestionMenu::OperationCompteBloque(C.compteCB);
                                break;}
                        default:cout<<"Entrez un chiffre entre 0 et 4"<<endl;
                                break;
               }
...
{   int choix=0;
    ...
    do
    {   cout<<"***********************************************"<<endl;
        cout<<"Souhaitez vous faire une operation sur ce compte courant?"<<endl;
        cout<<endl;
                ...
                switch(choix)
                    {
                        ...
                        case 6: {   cout<<"souhaitez vous exportez vos donnees ou supprimer le fichier?\n";
                                ...
                                break;}
                        default:cout<<"Entrez un chiffre entre 0 et 6"<<endl;
                                break;
                }
    ...
    double interets=0;
        do
            {   cout<<"***********************************************"<<endl;
                ...
                cout<<"4) Sauvegarder les donnees sur un fichier auxiliaire csv"<<endl;
                cout<<"5) Supprimer le fichier et en creer un nouveau"<<endl;
                cout<<"6) Rechercher par indice"<<endl;
                cout<<"7) Ecrire dans le fichier"<<endl;
                cout<<"0) Quitter le sous programme"<<endl;
                cout<<"Saisir votre choix\n";
                cin>>choix;
                    if(i=choix<0 && choix>7)
                        cout << "Mauvais choix, recommencez" << endl;
                ...
                switch(choix)
                    {
                        ...
                        case 7: {   PEL.EcritureFichier();
                                break;}

                        default:cout<<"Entrez un chiffre entre 0 et 7"<<endl;
                               break;
               }
                ...
                switch(choix)
                        {
                            ...
                            default:cout<<"Entrez un chiffre entre 0 et 3"<<endl;
                                    break;
                }
