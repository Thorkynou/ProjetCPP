...
private:
       //date  evenement;
        ...
        string nomActions;//nom de l'action realise (ajout, retrait....)
...
public:
      ...
      // comptecourant();//constructeur par defaut
        ...
        comptecourant(string nomActions="vide",int numerodecompte=256352,double solde=1500.0,double decouvert=-500.0,double taux=0.30,bool debiteur=true,
       ...
       comptecourant &operator=(const comptecourant & CC);//operation d'affectation
        ...
        void EcritureFichier()const;//ecriture dans un fichier
